...
import com.smart.framework.monitor.server.common.client.ClientManagerProvider;
...
import com.smart.framework.monitor.server.event.domain.ClientDeregisterEvent;
import com.smart.framework.monitor.server.event.domain.ClientRegisteredEvent;
import com.smart.framework.monitor.server.event.domain.ClientRegisteredUpdateEvent;
