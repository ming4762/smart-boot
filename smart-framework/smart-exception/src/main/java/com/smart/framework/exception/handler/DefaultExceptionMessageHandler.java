...
import com.smart.framework.commons.core.message.ExceptionResult;
import com.smart.framework.commons.core.message.Result;
import com.smart.framework.exception.processor.ExceptionMessageProcessor;
...
public class DefaultExceptionMessageHandler implements ExceptionMessageHandler, InitializingBean, ApplicationContextAware {
    ...
    public void afterPropertiesSet() {
        ...
        // 存储类型
        final Map<Type, List<ExceptionMessageProcessor>> classListMap = HashMap.newHashMap(8);
        ...
        classListMap.forEach((type, exceptionMessageProcessors) -> {
            if (exceptionMessageProcessors.size() == 1) {
                messageProcessorMap.put(type, exceptionMessageProcessors.getFirst());
            } else {
