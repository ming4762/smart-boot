package com.smart.framework.auth.extensions.saml2;
 ...
 */
@Slf4j
public class AuthSaml2SecurityConfigurer<H extends HttpSecurityBuilder<H>> extends SmartSecurityConfigurerAdapter<H> {
