package com.smart.framework.auth.core.utils.request;
...
public class MatcherHttpServletRequest implements HttpServletRequest {
     ...
     * depends on the browser and com.smart.framework.tool.code.type of authentication. Same as the value of
     ...
     *                                handler
     * @return A newly created instance of the specified upgrade handler com.smart.framework.tool.code.type
    ...
    /**
     * Returns the MIME com.smart.framework.tool.code.type of the body of the request, or <code>null</code> if
     * the com.smart.framework.tool.code.type is not known. For HTTP servlets, same as the value of the CGI
     * variable CONTENT_TYPE.
     *
     * @return a <code>String</code> containing the name of the MIME com.smart.framework.tool.code.type of the
     * request, or null if the com.smart.framework.tool.code.type is not known
     */
    @Override
     ...
     * of com.smart.framework.tool.code.type String. The values in the parameter map are of com.smart.framework.tool.code.type
     * String array.
     */
    @Override
     ...
     * sent the request. If the com.smart.framework.tool.code.engine cannot or chooses not to resolve the
