package com.smart.framework.auth.core.i18n;
...
public enum AuthI18nMessage implements I18nMessage {
    ...
    // 不支持的登录类型
    WECHAT_LOGIN_TYPE_NOT_SUPPORT("auth.error.wechat.loginTypeNotSupport", "Unsupported WeChat login com.smart.framework.tool.code.type"),
    WECHAT_USER_NOT_BOND("auth.error.wechat.userBindError", "WeChat user not bound"),
    WECHAT_APP_APPID_NOT_CONFIG("auth.error.wechat.app.appidNotConfig", "Appid not com.smart.framework.tool.code.config"),
