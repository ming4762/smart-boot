...
public class CacheUtils {
     ...
     * 数据库字段与Field映射缓存
     */
    private static final ConcurrentMap<Class<? extends AbstractDatabaseBaseDO>, Map<String, Field>> DATABASE_FIELD_MAPPING = new ConcurrentHashMap<>();

    /**
     * 类型映射
     */
    private static final ConcurrentMap<Integer, TypeMappingEnum> TYPE_MAPPING_CACHE = new ConcurrentHashMap<>();

    /**
     * converter缓存
     */
    private static final ConcurrentMap<Class<? extends Converter<?, ?>>, Converter<?, ?>> CONVERTER_CACHE = new ConcurrentHashMap<>();

    /**
     * 自动转换器存储
     */
    private static final ConcurrentMap<String, Converter<?, ?>> AUTO_CONVERTER_CACHE = new ConcurrentHashMap<>();

    /**
     * extjs与java映射
     */
    private static final ConcurrentMap<String, ExtMappingEnum> EXT_JAVA_MAPPING_CACHE = new ConcurrentHashMap<>();
