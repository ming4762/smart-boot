package com.smart.framework.tool.database.pool;
...
public class DbConnectionProvider implements InitializingBean, DisposableBean {
     ...
     * 存储连接池
     */
    private static final Map<DbConnectionConfig, GenericKeyedObjectPool<DbConnectionConfig, Connection>> POOL_MAP = new ConcurrentHashMap<>(16);
