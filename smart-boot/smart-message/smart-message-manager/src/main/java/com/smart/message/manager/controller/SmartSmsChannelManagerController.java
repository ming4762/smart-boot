...
import com.smart.message.manager.pojo.paramteter.SmartSmsChannelManagerSaveUpdateParameter;
import com.smart.message.manager.pojo.paramteter.SmartSmsSendTestParameter;
...
public class SmartSmsChannelManagerController extends BaseController<SmartSmsChannelManagerService, SmartSmsChannelManagerPO> {
    ...
    public Result<SmsSendDTO> sendTest(@RequestBody @Valid SmartSmsSendTestParameter parameter) {
