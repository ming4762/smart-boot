package com.smart.service.system.controller;
 ...
 */
@RestController
@RequestMapping("/public/access/api")
public class TestController {
    ...
    public Result<Boolean> testSecret() {
        return Result.success();
    }

    @PostMapping("testDelete")
    public Result<Boolean> testDelete() {
        this.sysUserService.remove(
                new QueryWrapper<SysUserPO>().lambda()
                        .eq(SysUserPO::getUsername, "2121")
        );
        return Result.success(true);
    }

    public static void main(String[] args) {
        Object object = Enhancer.create(TableInfo.class, (MethodInterceptor) (o, method, objects, methodProxy) -> {
