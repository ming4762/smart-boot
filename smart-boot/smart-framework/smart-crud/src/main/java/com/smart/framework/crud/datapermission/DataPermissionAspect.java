...
import com.smart.framework.crud.query.CommonQuery;
...
public class DataPermissionAspect {
    ...
    public void before(JoinPoint point, DataPermission dataPermission) {
        ...
        var deptAliasSql = !StringUtils.hasText(deptAlias) ? "" : deptAlias + ".";
        var userAliasSql = !StringUtils.hasText(userAlias) ? "" : userAlias + ".";
