package com.smart.file.extensions.nfs.utils;
...
public class JcraftUtils {
     ...
     * @return session
     */
    public static Session createSession(SmartFileProperties.SmartJcraftProperties properties) throws JSchException {
