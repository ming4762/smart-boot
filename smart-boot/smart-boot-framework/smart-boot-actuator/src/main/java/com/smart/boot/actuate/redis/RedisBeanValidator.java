package com.smart.boot.actuate.redis;
...
public class RedisBeanValidator implements ApplicationContextAware {
    ...
    public void setApplicationContext(@NonNull ApplicationContext applicationContext) throws BeansException {
        boolean result = ClassUtils.isPresent("com.smart.starter.redis.com.smart.framework.tool.code.service.RedisService", null);
        if (result) {
            try {
