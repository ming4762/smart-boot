package com.smart.module.system.controller.api.form.dto;
...
public class SmartFormTableSelectApiDTO implements Serializable {
    ...
    @Schema(title = "实体类名", example = "com.smart.system.com.smart.framework.tool.code.model.SysUserPO", requiredMode = Schema.RequiredMode.REQUIRED)
