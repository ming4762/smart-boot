...
import com.smart.system.pojo.dto.tenant.SysTenantSubscribeSaveUpdateDTO;
...
public class SysTenantSubscribeController extends BaseController<SysTenantSubscribeService, SysTenantSubscribePO> {
    ...
    @PreAuthorize("hasPermission('sys:tenant:subscribe', 'save') or hasPermission('sys:tenant:subscribe', 'update')")
    ...
    @PreAuthorize("hasPermission('sys:tenant:subscribe', 'delete')")
    ...
    @PreAuthorize("hasPermission('sys:tenant:subscribe', 'setUseYn')")
