...
INSERT INTO sys_function (function_id, parent_id, function_name, function_type, i18n_code, seq, create_time, create_user_id, update_time, update_user_id, url, permission, is_menu, internal_or_external, data_rule, http_method, remark, icon) VALUES (1472573741203490, 21, '创建账户', '30', null, 60, sysdate(), 1, null, null, '/auth/createAccount', 'sys:auth:createAccount', 1, 0, 0, 'POST', null, null);
