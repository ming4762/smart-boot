<template>
  <div class="full-height code-container" id="codeTemplateContainer" style="padding: 10px">
    <LayoutSeparate :show-line="false" first-size="240px" class="full-height">
      <template #first>
        <div class="full-height" style="background: white; margin-right: 5px">
...
import { getTableColumns, getSearchSchemas, getAddEditFormSchemas } from './CodeTemplateList.config'
