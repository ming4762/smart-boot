<template>
  <div class="full-height" style="padding: 10px">
    <a-layout class="full-height i18n-main-container">
      ...
      <a-layout>
        <a-layout-content class="i18n-container" style="background: #f0f2f5; margin-bottom: 2px">
          <I18nList :group-id="groupId" @change="(id) => (i18nId = id)" />
        </a-layout-content>
        <a-layout-content class="i18n-item-container" style="background: antiquewhite">
