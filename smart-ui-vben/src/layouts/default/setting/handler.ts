...
export function handler(event: HandlerEnum, value: any): DeepPartial<ProjectConfig> {
  ...
  switch (event) {
    ...
    case HandlerEnum.BUTTON_SIZE:
      return { sizeConfig: { button: value } }
    case HandlerEnum.FORM_SIZE:
      return { sizeConfig: { form: value } }
    case HandlerEnum.TABLE_SIZE:
      return { sizeConfig: { table: value } }
    default:
      return {}
  }
}
