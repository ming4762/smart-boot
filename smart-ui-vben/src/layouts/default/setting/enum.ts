 ...
 * 表格尺寸
 */
export const tableSize = ['medium', 'small', 'mini'].map((item) => {
  return {
    label: item,
    value: item,
  }
...
export const buttonSize = ['large', 'middle', 'small'].map((item) => {
  return {
    label: item,
    value: item,
  }
...
export const formSize = ['large', 'default', 'small'].map((item) => {
  return {
    label: item,
    value: item,
  }
