...
export default defineComponent({
  ...
  setup (props) {
    ...
    const tableSortableVue = vueSupportVxeSortable(tableRef, '.table-drop', data)
    ...
    return {
      ...
      headerSortableCheckboxChecked: vueTableHeaderCheckboxSupport(data, 'sortable', false).checked,
      headerResizableCheckboxChecked: vueTableHeaderCheckboxSupport(data, 'resizable', false).checked,
      headerHiddenCheckboxChecked: vueTableHeaderCheckboxSupport(data, 'hidden', false).checked,
      headerEditableCheckboxChecked: vueTableHeaderCheckboxSupport(data, 'editable', false).checked
    }
  },
  data () {
    return {
