...
import { TemplateType } from '@/modules/generator/constants/DatabaseConstants'
...
export default defineComponent({
  ...
  data () {
    return {
      ...
      rules: {
        packages: [
          { required: true, message: this.$t('generator.views.codeCreateForm.validate.packages'), trigger: 'blur' }
        ],
        className: [
          { required: true, message: this.$t('generator.views.codeCreateForm.validate.className'), trigger: 'blur' }
        ],
        controllerBasePath: [
          { required: true, message: this.$t('generator.views.codeCreateForm.validate.controllerBasePath'), trigger: 'blur' }
        ]
      }
    }
  }
