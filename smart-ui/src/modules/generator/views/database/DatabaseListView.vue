  ...
  data () {
    return {
      ...
      columns: [
        ...
        {
          title: this.$t('generator.views.database.table.connectionName'),
          field: 'connectionName',
          width: 160,
          fixed: 'left'
        },
        {
          title: this.$t('generator.views.database.table.databaseName'),
          field: 'databaseName',
          width: 160,
          fixed: 'left'
        },
        {
          title: this.$t('generator.views.database.table.type'),
          field: 'type',
          width: 120
        },
        {
          title: this.$t('generator.views.database.table.project'),
          field: 'project',
          width: 120
        },
        {
          title: this.$t('generator.views.database.table.url'),
          field: 'url',
          minWidth: 200,
          showOverflow: 'tooltip'
        },
        {
          title: this.$t('generator.views.database.table.username'),
          field: 'username',
          width: 120
        },
        {
          title: this.$t('generator.views.database.table.tableSchema'),
          field: 'tableSchema',
          width: 120
        },
        {
