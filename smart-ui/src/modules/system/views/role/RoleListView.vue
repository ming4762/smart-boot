  ...
  data () {
    return {
      ...
      columns: [
        ...
        {
          title: this.$t('system.views.role.table.roleName'),
          field: 'roleName',
          width: 120,
          fixed: 'left'
        },
        {
          title: this.$t('system.views.role.table.roleCode'),
          field: 'roleCode',
          width: 150,
          fixed: 'left'
        },
        {
          title: this.$t('system.views.role.table.roleType'),
          field: 'roleType',
          width: 120
        },
        {
        ...
        {
          title: this.$t('common.table.remark'),
          field: 'remark',
          minWidth: 160
        },
        {
